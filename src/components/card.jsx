...
export default function Card({title,author,img}) {
  return (
    <div className='w-[300px] mb-[20px] cursor-pointer h-auto p-padding2 flex flex-col h-auto gap-gap2 items-center transition duration-[0.3s] rounded-rounded2 hover:bg-glass
